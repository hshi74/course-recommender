...
class Sidebar extends React.Component {
  ...
  setCourses() {
    if(this.subject.current != null && this.interestArea.current != null && this.minimumCredits.current != null && this.maximumCredits.current != null) {
      this.props.setCourses(this.searchAndFilter.searchAndFilter(this.props.courses,this.search.current.value, 
        this.subject.current.value, this.interestArea.current.value, this.minimumCredits.current.value, this.maximumCredits.current.value));
    }
  }
  ...
  getInterestAreaOptions() {
    ...
    for(const interestArea of this.props.interestArea) {
